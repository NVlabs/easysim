...
ISAAC_GYM_CONFIG.PHYSX.NUM_THREADS = 0

ISAAC_GYM_CONFIG.PHYSX.CONTACT_OFFSET = 0.02

ISAAC_GYM_CONFIG.PHYSX.REST_OFFSET = 0.001

ISAAC_GYM_CONFIG.PHYSX.NUM_POSITION_ITERATIONS = 4

ISAAC_GYM_CONFIG.PHYSX.NUM_VELOCITY_ITERATIONS = 1

ISAAC_GYM_CONFIG.PHYSX.MAX_DEPENETRATION_VELOCITY = 100.0

ISAAC_GYM_CONFIG.PHYSX.MAX_GPU_CONTACT_PAIRS = 1048576

ISAAC_GYM_CONFIG.PHYSX.NUM_SUBSCENES = 0
...
ISAAC_GYM_CONFIG.PHYSX.DEFAULT_BUFFER_SIZE_MULTIPLIER = 2.0
